...
void exposeControlPolyTwoRK3() {
  bp::register_ptr_to_python<boost::shared_ptr<ControlPolyTwoRK3> >();

  bp::class_<ControlPolyTwoRK3, bp::bases<ControlAbstract> >(
      "ControlPolyTwoRK3",
      "Quadratic control.\n\n"
      ...
      .def("value", &ControlPolyTwoRK3::value_u, bp::args("self", "t", "p"),
           "Compute the control value.\n\n"
           ":param t: normalized time in [0, 1].\n"
           ":param p: control parameters (dim control.np).\n"
           ":return u value (dim control.nu).")
      .def("value_inv", &ControlPolyTwoRK3::value_inv_p, bp::args("self", "t", "u"),
           "Compute the control value.\n\n"
           ":param t: normalized time in [0, 1].\n"
           ":param u: control value (dim control.nu).\n"
           ":return p value (dim control.np).")
      .def("convert_bounds", &ControlPolyTwoRK3::convert_bounds, bp::args("self", "u_lb", "u_ub"),
      ...
      .def("dValue", &ControlPolyTwoRK3::dValue_J, bp::args("self", "t", "p"),
      ...
      .def("multiplyByDValue", &ControlPolyTwoRK3::multiplyByDValue_J, bp::args("self", "t", "p", "A"),
      ...
      .def("multiplyDValueTransposeBy", &ControlPolyTwoRK3::multiplyDValueTransposeBy_J, bp::args("self", "t", "p", "A"),
      ...
      .add_property("nu", bp::make_function(&ControlPolyTwoRK3::get_nu), "dimension of control tuple")
      .add_property("np", bp::make_function(&ControlPolyTwoRK3::get_np),
